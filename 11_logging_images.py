...
if __name__=="__main__":
    ...
    with mlflow.start_run(run_name="logging_images", experiment_id=experiment.experiment_id) as run:
        ...
        mlflow.log_figure(fig_pr, "metrics2/precision_recall_curve.png")
        ...
        mlflow.log_figure(fig_roc, "metrics2/roc_curve.png")
        ...
        mlflow.log_figure(fig_cm, "metrics2/confusion_matrix.png")
